...
const FIRST_NAMES = [
  'Budi', 'Agus', 'Dedi', 'Eko', 'Rudi', 'Hendra', 'Andi', 'Bambang', 'Joko', 'Wawan',
  'Sri', 'Siti', 'Dewi', 'Rina', 'Yuni', 'Wati', 'Ani', 'Lestari', 'Fitri', 'Indah',
  'Ahmad', 'Muhammad', 'Fajar', 'Doni', 'Irwan', 'Yusuf', 'Taufik', 'Rizki', 'Gilang', 'Putra',
  'Nur', 'Nina', 'Wulan', 'Ratna', 'Yulia', 'Diah', 'Ika', 'Novi', 'Maya', 'Puji',
];

const SECOND_NAMES = [
  'Santoso', 'Wijaya', 'Kurniawan', 'Setiawan', 'Saputra', 'Pratama', 'Susanto', 'Hidayat', 'Firmansyah', 'Gunawan',
  'Lestari', 'Wulandari', 'Anggraini', 'Puspita', 'Handayani', 'Safitri', 'Ramadhani', 'Kusuma', 'Permata', 'Utami',
  'Nugroho', 'Hakim', 'Siregar', 'Simanjuntak', 'Wahyudi', 'Purnomo', 'Suryanto', 'Maulana', 'Ardiansyah', 'Prasetyo',
];

const CITIES = [
  'Jakarta', 'Bandung', 'Surabaya', 'Semarang', 'Yogyakarta', 'Bekasi', 'Bogor', 'Tangerang', 'Cirebon', 'Solo',
];

const STREETS = [
  'Jl. Merdeka', 'Jl. Sudirman', 'Jl. Diponegoro', 'Jl. Gatot Subroto', 'Jl. Ahmad Yani', 'Jl. Melati',
  'Jl. Kenanga', 'Jl. Mawar', 'Jl. Anggrek', 'Jl. Cendrawasih',
];
...
const COLUMNS = [
  'nik', 'name', 'company_id', 'status', 'is_delete', 'email', 'gender', 'religion',
  'birth_place', 'birth_date', 'no_identitas', 'address', 'mobile_phone_no',
  'education_level', 'education_major', 'mariage_status', 'blood_type',
  'employee_status_id', 'join_date', 'contract_date', 'company_name',
  'total_leave_n', 'total_leave_n_1', 'fingerprint_id', 'last_attendance_status',
  'is_shift', 'auto_generate_payroll', 'bpjs_calculation_method',
